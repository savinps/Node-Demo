...
////////////////////////////////////////////////////////////////////////////////
 ...
 router.post('/clusterForm',function(req,res,next){
  ...
  //  if (rootvg == null) {
  //    var commandString = " -n "+'\"'+viosname+'\"'+" -b "+build+ " -e "+mailid;
  //   console.log(commandString);
  //   console.log("Command Log");
  //  }
   //
  ...
  //   console.log("Command Log");
  // }
//   NODES : alev1 alev2 alev4 alev3
// BUILD : 1609A_61k
// SSP PATCH :
// ROOTVG DISKS:
// REPO DISK : hdisk20
// EMAIL ID : savinps@in.ibm.com
// NIM MASTER : isstnim01
// CLUSTER : ale_cluster
// MSTER NODE : alev4
...
// var commandString = " -f  input_file.txt";
// console.log(commandString);
var commandString = " -n "+'\"'+viosname+'\"'+" -b "+build+" -r "+'\"'+rootvg+'\"'+" -e "+mailid;


execProcess.result("./ssp_vios_setup_trail -f vios_file", function(err, response){
    console.log("Invoking master script");
  	if(!err){
      console.log("success");
  		console.log(response);
